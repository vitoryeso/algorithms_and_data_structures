...
main_data_structures: ./main_data_structures.cpp
	g++ -O1 -Wall -o ./bin/main_data_structures ./main_data_structures.cpp ./data_structures/cpp/vector.cpp ./data_structures/cpp/heap.cpp ./data_structures/cpp/queue_linkedlist.cpp ./data_structures/cpp/stack.h
